...
Route::GET('/home/manageCR', 'AdminController@index');
Route::GET('/home/manageAdminTeacher', 'AdminController@index');
Route::GET('/home/manageCourse', 'AdminController@index');
Route::GET('/home/manageClassroom', 'AdminController@index');
// Login and Logout
